...
public class ExerciseDAOImpl implements ExerciseDAO {
    ...
    public List<Exercise> getExercises(User user) {
        ...
        Query<Exercise> theQuery =
                currentSession.createQuery("FROM Exercise WHERE author=:user AND status=2", Exercise.class);
    ...
    public List<Exercise> getUserPendingExercises(User user) {
        ...
        Query<Exercise> theQuery =
                currentSession.createQuery("FROM Exercise WHERE author=:user AND status=1", Exercise.class);
        theQuery.setParameter("user", user);
        List<Exercise> resultList = theQuery.getResultList();
    ...
    public Set<Exercise> getExercisesByCategory(User user, String category) {
        ...
        Query<Exercise> query1 =
                currentSession.createQuery("FROM Exercise WHERE exerciseCategory=:category AND status=0", Exercise.class);
        query1.setParameter("category", exerciseCategory);

        Query<Exercise> query2 =
                currentSession.createQuery("FROM Exercise WHERE exerciseCategory=:category AND author=:user", Exercise.class);
        query2.setParameter("category", exerciseCategory);
        query2.setParameter("user", user);

        List<Exercise> exerciseList1 = query1.getResultList();
        List<Exercise> exerciseList2 = query2.getResultList();
        exerciseList1.addAll(exerciseList2);

        return new HashSet<>(exerciseList1);
    }
