...
public class Workout {
    ...
    @Column(name = "workout_name_pl")
    private String namePL;

    @Column(name = "workout_info")
    private String info;

    @Column(name = "workout_info_pl")
    ...
    public Workout(String name, String namePL, String info, String infoPL, Status status, User author, int exerciseAmount) {
        this.name = name;
        this.namePL = namePL;
        this.info = info;
        this.infoPL = infoPL;
